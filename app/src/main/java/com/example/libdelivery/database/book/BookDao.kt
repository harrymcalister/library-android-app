...
interface BookDao {
    ...
    @Query("SELECT b.id, b.title, b.image_url, b.authors, b.subject, b.year_published, b.copies_available, b.description, l.library_name FROM books b LEFT JOIN libraries l ON b.library_id = l.id")
